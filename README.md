...
- [Documentation](#documentation)
      - [⚠️ This is the docs for **TS-Pattern v4**. Find the docs for **TS-Pattern v3 here**.](#️-this-is-the-docs-for-ts-pattern-v4-find-the-docs-for-ts-pattern-v3-here)
  - [Code Sandbox Examples](#code-sandbox-examples)
  - [Getting Started](#getting-started)
    - [Example: a state reducer with ts-pattern](#example-a-state-reducer-with-ts-pattern)
    - [match(value)](#matchvalue)
    - [.with(pattern, handler)](#withpattern-handler)
    - [P.select(name?)](#pselectname)
    - [P.not(pattern)](#pnotpattern)
    - [`P.when()` and guard functions](#pwhen-and-guard-functions)
      - [using P.when(predicate)](#using-pwhenpredicate)
      - [Passing a guard function to `.with(...)`](#passing-a-guard-function-to-with)
    - [the `P._` wildcard](#the-p_-wildcard)
    - [.exhaustive(), .otherwise() and .run()](#exhaustive-otherwise-and-run)
    - [Matching several patterns](#matching-several-patterns)
